...
<div class="site-wrap">
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="accueil">Accueil</a> <span class="mx-2 mb-0">/</span> <strong
                        class="text-black">Animalerie</strong></div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-9 order-2">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-5">
                            <div class="float-md-left mb-4"><h2 class="text-black h5">Tous les animaux</h2></div>
                            <div class="d-flex">
                                <div class="dropdown mr-1 ml-md-auto">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-secondary btn-sm dropdown-toggle"
                                                id="dropdownMenuReference" data-toggle="dropdown">Trier
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                                            <a class="dropdown-item" href="#">Race-Espèce, A - Z</a>
                                            <a class="dropdown-item" href="#">Race-Espèce, Z - A</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="#">Prix, [Bas - Haut]</a>
                                            <a class="dropdown-item" href="#">Prix, [Haut - Bas]</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
