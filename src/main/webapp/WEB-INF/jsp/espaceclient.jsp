...
<body>
	<div class="site-wrap">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="accueil">Accueil</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Espace client</strong>
					</div>
				</div>
			</div>
		</div>
		<div class="site-section">
			<div class="container">
				<form:form class="row" action="/updateUser/{id}" method="post"
					...
					<div class="col-md-12 mb-5 mb-md-0">
						...
						<div class="p-3 p-lg-5 border">
							...
							<div class="form-group row">
								<div class="col-md-6">
									<label for="nom" class="text-black"> Nom<span
								...
								<div class="col-md-6">
									<label for="prenom" class="text-black"> Prénom<span
										class="text-danger">*</span>
									</label>
							...
							<div class="form-group row">
								<div class="col-md-6">
									<label for="dateNaissance" class="text-black"> Date de
										naissance<span class="text-danger">*</span>
									</label>
									<form:input type="date" class="form-control" id="dateNaissance"
										path="dateNaissance" />
									<div class="pl-3">
								...
								<div class="col-md-6">
									<label for="telephone" class="text-black"> Téléphone<span
										class="text-danger">*</span>
									</label>
							...
							<div class="form-group row mb-5">
								<div class="col-md-6">
									<label for="password" class="text-black"> Mot de passe
							...
							<div class="form-group">
								<label for="summary" class="text-black"> Adresses de
									livraison </label>
							...
							<div class="form-group">
								<button type="submit"
									class="btn btn-primary btn-lg py-3 btn-block">Mettre à
									jour</button>
							</div>
						</div>
					</div>
